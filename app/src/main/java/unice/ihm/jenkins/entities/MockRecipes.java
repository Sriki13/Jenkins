...
public class MockRecipes {
    ...
    public static Recipe getRecipe(String recipes) {
        if(recipes.equals("Pizza pate feuilletée")) {
            return new Recipe(0,"Pizza pate feuilletée", "Beaucoup de finesse pour cette pizza un peu spéciale où la pâte traditionnelle est remplacée par une pâte feuilletée.\n" +
        ...
        else if(recipes.equals("One Pot Pasta")) //pasta recipe case
        {
            return new Recipe(1,"One Pot Pasta", "Mais qu'est-ce que c'est ?\n" +
        ...
        else if(recipes.equals("Galettes au quinoa et courgettes")) {
            return new Recipe(2,"Galettes au quinoa et courgettes", "Des galettes légères et rapides à préparer, idéales en entrée ou comme plat végétarien.",
                    ...
                    Arrays.asList(
                            ...
                            new Ingredient("Origan séché", 1, "cuillères à café"),
                            new Ingredient("Sel", 1, "cuillères à café")
                    ),
                    Arrays.asList(
